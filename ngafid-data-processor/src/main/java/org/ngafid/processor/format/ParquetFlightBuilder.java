...
public class ParquetFlightBuilder extends FlightBuilder {
    ...
    protected List<ComputeStep> gatherSteps(Connection connection) {
        List<ComputeStep.Factory> parquetSteps = List.of(
                required(ComputeStartEndTime::new), ComputeAltAGL::new, ComputeAirportProximity::new
                // Skipping steps: ComputeLaggedAltMSL::new, ComputeTurnToFinal::new, ComputeItinerary::new,
                // ComputeLOCI::new, ComputeTotalFuel::new, ComputeDivergence::new,  ComputeStallIndex::new,
                );
