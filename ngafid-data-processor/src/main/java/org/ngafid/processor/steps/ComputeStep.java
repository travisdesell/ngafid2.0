 ...
 * <p>
 * Compute steps modify a flight builder object (an intermediate representation of a flight) as they see fit, but the
 * primary output comes in the form of columns. Steps should generally not mess with anything they are not directly
 * intended to in the flight builder,
 ...
 * <p>
 * So, compute steps have required input columns and output columns. We can use these relationships to form a graph of
 * the compute steps which can then be executed in parallel.
