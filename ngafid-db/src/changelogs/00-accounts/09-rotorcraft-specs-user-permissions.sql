...
--changeset ngafid:rotorcraft-specs-user-permissions labels:accounts,rotorcraft,airframe-specs
...
--changeset ngafid:rotorcraft-specs-drop-fleet-access labels:flights,rotorcraft,airframe-specs
DROP TABLE IF EXISTS rotorcraft_airframe_spec_fleet_access;

--changeset ngafid:rotorcraft-specs-drop-fleet-columns labels:flights,rotorcraft,airframe-specs
--preconditions onFail:MARK_RAN onError:HALT
