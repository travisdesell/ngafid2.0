...
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA IN (DATABASE(), SCHEMA()) AND TABLE_NAME = 'events' AND COLUMN_NAME = 'min_latitude'
