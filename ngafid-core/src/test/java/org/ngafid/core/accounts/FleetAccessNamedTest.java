...
public class FleetAccessNamedTest {
    ...
    private void createTestData() throws SQLException {
        // Create test fleets
        try (PreparedStatement stmt = connection.prepareStatement("INSERT INTO fleet (id, fleet_name) VALUES "
        ...
        // Create test users
        try (PreparedStatement stmt =
                connection.prepareStatement("INSERT INTO user (id, email, password_token, first_name, "
