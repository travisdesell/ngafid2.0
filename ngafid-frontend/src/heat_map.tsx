...
const allEventNames = [
    ...
    "Low Obstacle Collision Risk",
    "Low Oil Pressure",
    "Low Pitch",
    "Low Positional Accuracy",
    "Low Vertical Acceleration",
    "Medium Obstacle Collision Risk",
    "Proximity",
    "Roll",
    "Tail Strike",
    "VSI on Final"
...
const eventNameToDefinitionIds: { [eventName: string]: number[] } = {
    ...
    "High Obstacle Collision Risk": [-10],
    "High Pitch": [2],
    ...
    return (
        <div style={{ overflowX: 'hidden', display: 'flex', flexDirection: 'column', height: '100vh' }}>
            ...
            <div className="p-2" style={{overflowY: "auto", flex: "1 1 auto"}}>
                ...
                {/* Error Banner */}
                {error && (
                    <div className="alert alert-danger p-2 mx-3 mb-3 mt-2 flex flex-row items-center justify-start gap-2 z-100">
                        <strong>Error:</strong>
                        <span>{error}</span>
                ...
                {/* Loading Indicator */}
                {loading && (
                    <div className="alert alert-info p-2 mx-3 mb-3 mt-2 flex flex-row items-center justify-start gap-2 z-100">
