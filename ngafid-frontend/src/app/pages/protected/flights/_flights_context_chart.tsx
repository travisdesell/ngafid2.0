...
export interface FlightsChartState {
    ...
    labelingEnabledFlightIds: Array<number>;
    selectedLabelingParamByFlight: Record<number, string>;
    pendingLabelStartXByFlight: Record<number, number | null>;
    labelSectionsByFlight: Record<number, Array<FlightLabelSection>>;

    selectedIds: Set<number>;
}

export interface FlightLabelSection {
    id: number | null;
    startIndex: number;
    endIndex: number;
    startTime: number;
...
export interface FlightsChartContextValue extends FlightsChartState {
    ...
    setFlightLabelSections: (flightId: number, sections: Array<FlightLabelSection>) => void;
