...
public class C182LowFuelEvent extends Event {
    ...
    public static boolean isOccuring(ArrayList<String> lineValues) {
        double c152LowFuelLeft = Double.parseDouble(lineValues.get(c182LowFuelLeftColumn));
        double c152LowFuelRight = Double.parseDouble(lineValues.get(c182LowFuelRightColumn));
