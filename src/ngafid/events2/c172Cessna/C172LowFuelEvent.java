...
public class C172LowFuelEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a C172 Low Fuel event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a C172 Low Fuel event
                int flightId = flightsRS.getInt(1);

                //grab the C172 Low Fuel double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("C172 Low Fuel exceedence at entry: " + i);
                        }
                    }
                }
