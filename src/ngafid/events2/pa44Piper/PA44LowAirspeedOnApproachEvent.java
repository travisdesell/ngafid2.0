...
public class PA44LowAirspeedOnApproachEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a PA44LowAirspeedOnApproach event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a PA44LowAirspeedOnApproach event
                int flightId = flightsRS.getInt(1);

                //grab the PA44LowAirspeedOnApproach double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("PA44LowAirspeedOnApproach exceedence at entry: " + i);
                        }
                    }
                }
