...
public class SR20LowOilPressureEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a SR20LowOilPressure event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a SR20LowOilPressure event
                int flightId = flightsRS.getInt(1);

                //grab the SR20LowOilPressure double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("SR20LowOilPressure exceedence at entry: " + i);
                        }
                    }
                }
