...
public class C182HighAltitudeEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a C182HighAltitude event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a C182HighAltitude event
                int flightId = flightsRS.getInt(1);

                //grab the C182HighAltitude double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current > maxValue) {
                            System.err.println("C182HighAltitude exceedence at entry: " + i);
                        }
                    }
                }
