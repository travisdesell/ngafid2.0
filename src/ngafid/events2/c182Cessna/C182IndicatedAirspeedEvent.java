...
public class C182IndicatedAirspeedEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a C182 Indicated Airspeed event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a C182IndicatedAirspeed event
                int flightId = flightsRS.getInt(1);

                //grab the C182IndicatedAirspeed double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("C182 Indicated Airspeed exceedence at entry: " + i);
                        }
                    }
                }
