...
public class CalculatePitch {
    ...
    public static void main(String[] arguments) {
        ...
        try {
            ...
            StringTimeSeries timeSeries = flight.getStringTimeSeries(timeSeriesName);
            ...
            for (int i = 0; i < pitchSeries.size(); i++) {
                ...
                if (current < minValue || current > maxValue){
                    ...
                    endLine = lineNumber;
                    System.out.println("pitch in line: " + "[" + lineNumber + "]" + " with Value: " + "[" + current + "]");
