...
public class C172LowAirspeedOnApproachEvent extends Event {
    ...
    private static final double c172RadioAltitudeDerivedLowLimit = 860; // 860 and 861  is only test number. The actual number is 100
    private static final double c172RadioAltitudeDerivedHighLimit = 861; // 861 and 861  is only test number. The actual number is 500
