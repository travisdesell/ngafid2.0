...
public class CalculateRateOfClosure {
    ...
    public static double[] calculateRateOfClosure(FlightTimeLocation flightInfo, FlightTimeLocation otherInfo ){
        ...
        double rateOfClosure[] = new double[flightInfo.endLine - flightInfo.startLine];
        ...
        int i = flightInfo.startLine, j = otherInfo.startLine, index = 0;
        while (i < flightInfo.endLine && j < otherInfo.endLine) {
