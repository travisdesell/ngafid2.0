...
public class GetAnnotationClasses implements Route {
    ...
    public static List<String> getAnnotationClasses(int fleetId) throws SQLException {
        String queryString = "SELECT name FROM loci_event_classes WHERE fleet_id = ?";
    ...
    public Object handle(Request request, Response response) {
        ...
        try {
            List<String> classes = getAnnotationClasses(fleetId);
