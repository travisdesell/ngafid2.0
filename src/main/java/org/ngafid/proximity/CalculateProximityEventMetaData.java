            ...
            while (resultSet.next()) {
                ...
                if (otherResultSet.next()) {
                    ...
                    while ( startLine < endLine && otherStartLine < otherEndLine ) {
                        ...
                        double distance = CalculateProximity.calculateDistance(latitude[startLine], longitude[startLine], otherLatitude[otherStartLine], otherLongitude[otherStartLine], altMSL[startLine], otherAltMSL[otherStartLine]);

                        if (distance < 1000.0 && indicatedAirSpeed[startLine] > 20 && otherIndicatedAirSpeed[otherStartLine] > 20 && altAGL[startLine] >= 50 && otherAltAgl[otherStartLine] >= 50 ) {
