...
public class SR20LowFuelEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a SR20LowFuel event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a SR20LowFuel event
                int flightId = flightsRS.getInt(1);

                //grab the SR20LowFuel double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("SR20LowFuel exceedence at entry: " + i);
                        }
                    }
                }
