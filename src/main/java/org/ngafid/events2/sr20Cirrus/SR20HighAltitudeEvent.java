...
public class SR20HighAltitudeEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a SR20HighAltitude event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a SR20HighAltitude event
                int flightId = flightsRS.getInt(1);

                //grab the SR20HighAltitude double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("SR20HighAltitude exceedence at entry: " + i);
                        }
                    }
                }
