...
public class PA44LowFuelEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a PA44LowFuel event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a PA44LowFuel event
                int flightId = flightsRS.getInt(1);

                //grab the PA44LowFuel double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("PA44LowFuel exceedence at entry: " + i);
                        }
                    }
                }
