...
public class PA28HighAltitudeEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a PA28HighAltitude event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a PA28HighAltitude event
                int flightId = flightsRS.getInt(1);

                //grab the PA28HighAltitude double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("PA28HighAltitude exceedence at entry: " + i);
                        }
                    }
                }
