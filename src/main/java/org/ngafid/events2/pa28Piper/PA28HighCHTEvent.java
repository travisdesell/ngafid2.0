...
public class PA28HighCHTEvent {
    ...
    public static void calculateEvents(Connection connection) {
        try {
            ...
            //grab the flight IDs that can have a PA28HighCHT event
            ...
            while (flightsRS.next()) {
                //get the ID from each flight that had a PA28HighCHT event
                int flightId = flightsRS.getInt(1);

                //grab the PA28HighCHT double_series for that flight
                ...
                while (resultSet.next()) {
                    ...
                    for (int i = 0; i < timeSeries.size(); i++) {
                        ...
                        if (current < minValue || current > maxValue) {
                            System.err.println("PA28HighCHT exceedence at entry: " + i);
                        }
                    }
                }
