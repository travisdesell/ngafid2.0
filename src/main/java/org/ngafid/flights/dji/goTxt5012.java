...
public class goTxt5012 extends DATRecord {
    ...
    public void process(Payload payload) {
        ...
        payloadBB = payload.getByteBuffer();
        valid = true;
...
//    public static DATSignal flightTimeSig = DATSignal.SeriesInt("flightTime",
//            "Flight Time", null, Units.msec);
//
//    public static DATSignal gpsHealthSig = DATSignal.SeriesInt("gpsHealth",
//            "GPS Health", null, Units.gpsHealth);

    public static DATSignal vpsHeightSig = DATSignal.SeriesDouble("vpsHeight", "vps Height", null, Units.meters);

    public static DATSignal relativeHeightSig = DATSignal.SeriesDouble("relativeHeight", "Height above Launch HomePoint", null, Units.meters);

    private static DATSignal flyCStateSig = DATSignal.State("flyCState", "FlyCState", "GPS_Atti");

    private static DATSignal flyCCommandSig = DATSignal.State("flycCommand", "FlycCommand", "AUTO_FLY");

    private static DATSignal flightActionSig = DATSignal.State("flightAction", "Flight Action", "NONE");

    private static DATSignal nonGPSCauseSig = DATSignal.State("nonGPSCause", "nonGPSCause", "ALREADY");

    private static DATSignal connectedToRCSig = DATSignal.State("connectedToRC", "Connected to RC", "Connected");

    private static DATSignal lowVoltageSig = DATSignal.State("Battery:lowVoltage", "Low Voltage", "");

    private static DATSignal rcModeSwitchSig = DATSignal.State("RC:ModeSwitch", "RC Mode Switch", "P");

    private static DATSignal gpsUsedSig = DATSignal.State("gpsUsed", "GPS Used for Horizontal Speed", "True");

    private static DATSignal visionUsedSig = DATSignal.State("visionUsed", "Vision Used for Horizontal Speed", "True");
