...
protected short xxbaro_temp = (short)0;
      ...
      public imu_raw_92(ConvertDat convertDat) {
           super(convertDat, 92, 30);
       }
...
@Override
 ...
 xxbaro_temp = _payload.getShort(28);
    ...
    protected static Signal imu_rawIntSig = Signal
.SeriesInt("imu_raw", "", null, Units.noUnits);
    protected static Signal imu_rawFloatSig = Signal
.SeriesFloat("imu_raw", "", null, Units.noUnits);
    protected static Signal imu_rawDoubleSig = Signal
.SeriesDouble("imu_raw", "", null, Units.noUnits);
