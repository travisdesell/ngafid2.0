...
public class Controller_41_1000 extends RecController {
    ...
    protected short app_connect_lost = (short) 0;

    public Controller_41_1000(ConvertDat convertDat) {
        super(convertDat, 1000, 41);
    }
    ...
    public void process(Payload _payload) {
        ...
        try {
            ...
            app_connect_lost = _payload.getUnsignedByte(40);
        } catch (Exception e) {
            RecordException(e);
        }
    }
