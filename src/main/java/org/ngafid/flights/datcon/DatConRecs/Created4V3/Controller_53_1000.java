...
public class Controller_53_1000 extends RecController {
    ...
    public void process(Payload _payload) {
        ...
        try {
            ...
            OH_take_f = _payload.getUnsignedByte(37);
            rc_cnt = _payload.getUnsignedByte(38);
            sup_rc = _payload.getUnsignedByte(39);
            is_soaring_up = _payload.getUnsignedByte(40);
            soar_up_timer = _payload.getFloat(41);
            vert_vel_err = _payload.getFloat(45);
            vert_vel_err_fltr = _payload.getFloat(49);
        } catch (Exception e) {
            RecordException(e);
        }
    }
