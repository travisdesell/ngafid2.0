...
public class Units {
    ...
    public static Units gpsCoord = new Units("degrees");
    ...
    public static Units wattsSecs = new Units("WattSecs");

    public static Units wattsSecsPerDist = new Units("WattSecs/Dist");

    public static Units wattsPerVel = new Units("Watts/Vel");
