...
public class ProcessDivergence extends ProcessStep {
    ...
    private static final List<DivergenceConfig> CESSNA_CONFIG =
        List.of(
    ...
    private static final List<DivergenceConfig> PA_44_CONFIG =
        List.of(
            new DivergenceConfig(List.of("E1 EGT1", "E1 EGT2", "E1 EGT3", "E1 EGT4"), "E1 EGT Divergence"),
            new DivergenceConfig(List.of("E2 EGT1", "E2 EGT2", "E2 EGT3", "E2 EGT4"), "E2 EGT Divergence")
        );
    
    private static final List<DivergenceConfig> SIX_CYLINDER_CIRRUS =
        List.of(
    ...
    private static final List<DivergenceConfig> DIAMOND_CONFIG =
        List.of(
            new DivergenceConfig(List.of("E1 CHT1", "E1 CHT2", "E1 CHT3", "E1 CHT4"), "E1 CHT Divergence"),
            new DivergenceConfig(List.of("E1 EGT1", "E1 EGT2", "E1 EGT3", "E1 EGT4"), "E1 EGT Divergence")
        );

    private static final Map<String, List<DivergenceConfig>> CONFIG_MAP =
        Map.ofEntries(
    ...
    public Set<String> getRequiredColumns() { return getRequiredDoubleColumns(); }
    ...
    private void calculateDivergence(List<String> columnNames, String varianceColumnName) throws MalformedFlightFileException, SQLException {
