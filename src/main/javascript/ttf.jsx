...
import { map, styles, layers, Colors, overlay, initializeMap, container, content, closer } from "./map.jsx";
import { TimeHeader, TurnToFinalHeaderComponents } from "./time_header.jsx";
import SignedInNavbar from "./signed_in_navbar.jsx";
import { paletteAt, paletteGenerator } from "./map_utils.jsx";
...
//the navbar includes flights.jsx (bad design) for the navbar buttons
