...
import { map, styles, layers, Colors, initializeMap } from "./map.jsx";
...
import { FlightsCard } from "./flights_card_component.jsx";

import Plotly from "plotly.jsx";

import { timeZones } from "./time_zones.jsx";
import { linearRingLength } from "ol/geom/flat/length.jsx";
import { View } from "ol";
...
class FlightsPage extends React.Component {
  ...
  /**
   * Calls the server using ajaxjson to notify it of the new tag change
   */
