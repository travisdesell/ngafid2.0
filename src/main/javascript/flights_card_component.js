                ...
                <div>
                    {
                        flights.map((flightInfo, index) => {
                            if(flightInfo != null) {
                                return (
                                    <Flight showPlot={() => {this.props.showPlot();}} showMap={() => {this.props.showMap();}} showCesiumPage={()=>{this.props.showCesiumPage();}} flightInfo={flightInfo} navBar={this.props.navBar} pageIndex={index}
